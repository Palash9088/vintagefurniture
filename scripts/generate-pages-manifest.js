...
const CATEGORY_RULES = [
  ...
  { id: 'cdp_identity', label: 'CDP & Identity', test: (n) => /^(segment|rudderstack|mparticle|clearbit|6sense|demandbase|albacross|zoominfo|zeotap|lytics|factorsai|air360|abtsegmentpush|abtmparticle|abtair360|abtysance|abtanil|abtadvalo)/.test(n) },
