...
const CATEGORY_RULES = [
  ...
  { id: 'marketing_automation', label: 'Marketing Automation', test: (n) => /^(hubspot|marketo|klaviyo|braze|clevertap|moengage|abthubspot|abtklaviyo|abtsfmc|sfmc)/.test(n) },
  ...
  { id: 'test_edge', label: 'Test & Edge Cases', test: (n) => /(random|withoutvwo|bodytag|both|timezonecalc|eventjourney|hubspottest|segmentvwotesting|segmentpush2|gtmwithoutsmartcode|gtmwithcookie|abtall|vwo-legacy)/.test(n) },
